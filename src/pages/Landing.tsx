            ...
            >
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative h-10 w-10 md:h-16 md:w-16 object-contain rounded-full p-1 transition-all duration-300" 
                />
              </div>
              <span className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent font-samarkan tracking-wide transition-all duration-300">
                Dhanvantari
              </span>
            </motion.div>
