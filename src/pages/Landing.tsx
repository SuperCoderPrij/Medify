...
import { ArrowRight, Shield, QrCode, CheckCircle, Activity, Lock, Smartphone, Database, AlertTriangle, MapPin, FileWarning, Send } from "lucide-react";
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white overflow-x-hidden font-sans selection:bg-cyan-500/30">
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-black/20 backdrop-blur-lg py-12 relative z-10">
